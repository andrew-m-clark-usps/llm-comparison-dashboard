...
- **Multi-Model Comparison** — Compare four leading LLM providers at once: OpenAI (ChatGPT), Anthropic (Claude), Google (Gemini), and Manus
...
- **Keyboard Shortcut:** Press `Ctrl+Enter` / `⌘+Enter` to submit a prompt
